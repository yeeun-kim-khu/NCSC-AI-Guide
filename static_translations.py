...
### 🚇 지하철로 오는 방법
- **4호선 혜화역 4번 출구**에서 나와서 창경궁 방향(북쪽)으로 쭉 걸으면 돼. 도보 약 7분!
  - 혜화역에서 나오면 창경궁 방향(북쪽)으로 쭉 걸어오면 돼요!
- **1호선 종로5가역 2번 출구** → 걸어서 약 20분

### 🚌 버스로 오는 방법
- **창경궁·서울대학교병원** 또는 **명륜3가·성대입구** 정류장에서 내려서 도보로 약 5분이면 도착이야.
- 간선(파랑)버스: 100, 102, 104, 107, 140, 143, 150, 151, 160, 162, 171, 172, 272, 301, 710번 등
...
- On-site payment available for remaining seats.
"""
    },
    "日本語": {
